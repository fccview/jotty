  ...
  const handleCleanupNow = async () => {
    ...
    try {
      ...
      showToast({
        ...
        title: t("auditLogs.cleanupError"),
        message:
          error instanceof Error ? error.message : t("auditLogs.cleanupError"),
      });
    } finally {
      setIsCleaning(false);
    }
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        {showCleanupCard && maxLogAge > 0 && (
          <div className="bg-warning/10 w-full border border-warning rounded-jotty p-4">
            <div className="flex flex-wrap lg:flex-nowrap w-full items-start gap-3">
