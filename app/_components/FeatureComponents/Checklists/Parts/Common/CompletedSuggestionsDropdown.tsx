      ...
      <div className="p-2">
        ...
        {completedItems.map((item) => (
          <button
            ...
            className="w-full flex items-center gap-2 px-2 py-2 text-md lg:text-sm hover:bg-accent hover:text-accent-foreground rounded-jotty transition-colors text-left"
          >
