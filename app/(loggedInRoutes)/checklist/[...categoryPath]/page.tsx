 ...
 * only exists to 301 pre-uuid links onto /checklist/[uuid] and will be deleted
 * a release after note content has been migrated. Do not build anything new on
 * top of it.
 */
export default async function LegacyChecklistPage(
  ...
  const uuid = await legacyResolve(
    Modes.CHECKLISTS,
    category,
    id,
    user.username,
