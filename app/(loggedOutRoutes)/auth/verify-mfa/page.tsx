...
export default function VerifyMfaPage() {
    ...
    const handleRecoveryCodeSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        setIsLoading(true);
        setError("");
        ...
        formData.append("useBackupCode", "true");
                ...
                {!useRecoveryCode ? (
                    ...
                    <form onSubmit={handleRecoveryCodeSubmit} className="space-y-4">
                        ...
                        >
                            {isLoading ? (
                                <>
                                    <Logo className="h-4 w-4 mr-2 animate-pulse" /> {t("mfa.verifying")}
                                </>
                            ) : (
                                t("mfa.verify")
                            )}
